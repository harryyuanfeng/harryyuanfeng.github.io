...
(function (e, t) {
    ...
    function o(o, i, n) {
        ...
        return r.timers = {resize: new a, register: function (e) {
            ...
            for (var i in l.breakpoints)r.breakpoints.push({name: i, width: l.breakpoints[i]}), r.breakpointNames += i + " ";
            ...
            var n = {index: i, hide: {}, type: a.data("type") || "alpha", name: a.data("name") || e.trim(a.text()), ignore: a.data("ignore") || !1, toggle: a.data("toggle") || !1, className: a.data("class") || null, matches: [], names: {}, group: a.data("group") || null, groupName: null};
            if (null !== n.group) {
            ...
            if (t.is(":visible") && r.hasAnyBreakpointColumn()) {
                ...
                if (t.data("footable_info", a), r.raise(s.resizing, {old: o, info: a}), !o || o && o.width && o.width !== a.width) {
            ...
            if (r.raise(s.rowDetailUpdating, {row: o, detail: i}), o.find("> td:hidden").each(function () {
                ...
                return a.ignore === !0 ? !0 : (t in a.names && (o = a.names[t]), n.push({name: o, value: r.parse(this, a), display: e.trim(e(this).html()), group: a.group, groupName: a.groupName}), !0)
            }), 0 === n.length)return!1;
            var u = o.find("> td:visible").length, f = i.hasClass(d.detail);
            return f || (i = e('<tr class="' + d.detail + '"><td class="' + d.detailCell + '"><div class="' + d.detailInner + '"></div></td></tr>'), o.after(i)), i.find("> td:first").attr("colspan", u), a = i.find("." + d.detailInner).empty(), l.createDetail(a, n, l.createGroupedDetail, l.detailSeparator, d), o.data("detail_created", !0), r.raise(s.rowDetailUpdated, {row: o, detail: i}), !f
    ...
    t.footable = {options: {delay: 100, breakpoints: {phone: 480, tablet: 1024}, parsers: {alpha: function (t) {
    ...
    }}, addRowToggle: !0, calculateWidthOverride: null, toggleSelector: " > tbody > tr:not(.footable-row-detail)", columnDataSelector: "> thead > tr:last-child > th, > thead > tr:last-child > td", detailSeparator: ":", toggleHTMLElement: "<span />", createGroupedDetail: function (e) {
        for (var t = {_none: {name: null, data: []}}, a = 0; e.length > a; a++) {
            var o = e[a].group;
            null !== o ? (o in t || (t[o] = {name: e[a].groupName || e[a].group, data: []}), t[o].data.push(e[a])) : t._none.data.push(e[a])
        }
        return t
        ...
        return version = /(\d+)\.?(\d+)?\.?(\d+)?/.exec(e), {major: parseInt(version[1], 10) || 0, minor: parseInt(version[2], 10) || 0, patch: parseInt(version[3], 10) || 0}
    }}, plugins: {_validate: function (a) {
...
(function (e, t, undefined) {
    function a() {
        ...
        t.name = "Footable Filter", t.init = function (a) {
            if (t.footable = a, a.options.filter.enabled === !0) {
                ...
                a.timers.register("filter"), e(a.table).unbind(".filtering").bind({"footable_initialized.filtering": function () {
                    var i = e(a.table), o = {input: i.data("filter") || a.options.filter.input, timeout: i.data("filter-timeout") || a.options.filter.timeout, minimum: i.data("filter-minimum") || a.options.filter.minimum, disableEnter: i.data("filter-disable-enter") || a.options.filter.disableEnter};
                    ...
                    var i = e(a.table), o = i.data("filter-string");
                    o && t.filter(o)
                }}).data("footable-filter", t)
            }
        }, t.filter = function (a) {
            var i = t.footable, o = e(i.table), n = o.data("filter-minimum") || i.options.filter.minimum, r = !a, l = i.raise("footable_filtering", {filter: a, clear: r});
    ...
    var i = {filter: {enabled: !0, input: ".footable-filter", timeout: 300, minimum: 2, disableEnter: !1, filterFunction: function () {
        var t = e(this), a = t.parents("table:first"), i = a.data("current-filter").toUpperCase(), o = t.find("td").text();
    ...
    function i() {
        ...
        t.name = "Footable Paginate", t.init = function (a) {
            if (a.options.paginate === !0) {
                ...
                t.footable = a, e(a.table).unbind(".paging").bind({"footable_initialized.paging footable_row_removed.paging footable_redrawn.paging footable_sorted.paging footable_filtered.paging": function () {
                    t.setupPaging()
                }}).data("footable-paging", t)
            }
        }, t.setupPaging = function () {
            var i = t.footable, o = e(i.table).find("> tbody");
            ...
            var i = 1, o = t.pageInfo, n = i * o.pageSize, l = [], r = [];
            o.pages = [];
            ...
            if (0 !== i.length) {
                ...
                o.control = i, o.pages.length > 0 && (i.append('<li class="footable-page-arrow"><a data-page="first" href="#first">' + a.pageInfo.firstText + "</a>"), i.append('<li class="footable-page-arrow"><a data-page="prev" href="#prev">' + a.pageInfo.previousText + "</a></li>"), o.limit && i.append('<li class="footable-page-arrow"><a data-page="limit-prev" href="#limit-prev">' + a.pageInfo.limitPreviousText + "</a></li>"), o.limit || e.each(o.pages, function (e, t) {
                    ...
                    n.preventDefault();
                    var l = e(this).data("page"), r = o.currentPage;
            ...
            var i, o, n = e.find('li.footable-page-arrow > a[data-page="limit-prev"]').parent(), l = e.find('li.footable-page-arrow > a[data-page="limit-next"]').parent();
            ...
            var o = a.pageInfo;
            if (o.currentPage !== i) {
                var n = e(a.table).find("> tbody"), l = a.raise("footable_paging", {page: i, size: o.pageSize});
...
(function (e, t, undefined) {
    function a() {
        ...
        t.name = "Footable Sortable", t.init = function (a) {
            t.footable = a, a.options.sort === !0 && e(a.table).unbind(".sorting").bind({"footable_initialized.sorting": function () {
                var i, o, n = e(a.table), r = (n.find("> tbody"), a.options.classes.sort);
                if (n.data("sort") !== !1) {
                ...
                var i = e(a.table), o = a.options.classes.sort;
            ...
            if (e(o.table).data("sort") !== !1) {
                var n = e(o.table), r = n.find("> tbody"), l = o.columns[a], s = n.find("> thead > tr:last-child > th:eq(" + a + ")"), d = o.options.classes.sort, f = o.options.events.sort;
                ...
                u && u.result === !1 || (n.data("sorted", l.index), n.find("> thead > tr:last-child > th, > thead > tr:last-child > td").not(s).removeClass(d.sorted + " " + d.descending), i === undefined && (i = s.hasClass(d.sorted)), i ? s.removeClass(d.descending).addClass(d.sorted) : s.removeClass(d.sorted).addClass(d.descending), t.sort(o, r, l, i), o.bindToggleSelectors(), o.raise(f.sorted, {column: l, direction: i ? "ASC" : "DESC"}))
            }
            ...
            var n = t.rows(e, a, i), r = e.options.sorters[i.type] || e.options.sorters.alpha;
            n.sort(function (e, t) {
    ...
    if (t.footable === undefined || null === t.footable)throw Error("Please check and make sure footable.js is included in the page and is loaded prior to this script.");
    var i = {sort: !0, sorters: {alpha: function (e, t) {
        return"string" == typeof e && (e = e.toLowerCase()), "string" == typeof t && (t = t.toLowerCase()), e === t ? 0 : t > e ? -1 : 1
    }, numeric: function (e, t) {
        return e - t
    }}, classes: {sort: {sortable: "footable-sortable", sorted: "footable-sorted", descending: "footable-sorted-desc", indicator: "footable-sort-indicator"}}, events: {sort: {sorting: "footable_sorting", sorted: "footable_sorted"}}};
    t.footable.plugins.register(a, i)
})(jQuery, window);
;
(function (e, t, undefined) {
    function a() {
        ...
        t.name = "Footable Striping", t.init = function (a) {
            t.footable = a, e(a.table).unbind("striping").bind({"footable_initialized.striping footable_row_removed.striping footable_redrawn.striping footable_sorted.striping footable_filtered.striping": function () {
...
(function (e, t, undefined) {
    ...
    function i(t, a) {
        ...
        var n = e(t.table).data("sorted"), r = e(t.table).find("th")[n], l = e(r).hasClass("footable-sorted-desc");
        if (e(t.table).data("status_descending", l), t.pageInfo) {
            var s = t.pageInfo.currentPage;
            e(t.table).data("status_pagenum", s)
        }
        var d = "", f = e(t.table).data("filter");
    ...
    function o() {
        ...
        t.name = "Footable LucidBookmarkable", t.init = function (t) {
            t.options.bookmarkable.enabled && e(t.table).bind({footable_initialized: function () {
                var i = t.table.id, o = a(i + "_f"), n = a(i + "_p"), r = a(i + "_s"), l = a(i + "_d"), s = a(i + "_e");
                if (o) {
                ...
                if (n && e(t.table).data("currentPage", n), r !== undefined) {
                    var f = e(t.table).data("footable-sort"), p = !0;
                ...
                if (i(t, a), t.lucid_bookmark_read) {
                    var o = t.table.id, n = o + "_f", r = o + "_p", l = o + "_s", s = o + "_d", d = o + "_e", f = location.hash.replace(/^\#/, "&"), p = [n, r, l, s, d];
                    for (var u in p) {
                        var g = RegExp("&" + p[u] + "=([^&]*)", "g");
                        f = f.replace(g, "")
                    }
